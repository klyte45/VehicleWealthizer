...
namespace Klyte.Commons.Interfaces
{
        ...
        where T : UICustomControl
    {
        ...
        public static SavedBool debugMode { get; } = new SavedBool("VWDebugMode", Settings.gameSettingsFile, false, true);
        ...
        {
            instance = this as U;
            Debug.LogWarningFormat("VWv" + majorVersion + " LOADING ");
            LoadSettings();
            Debug.LogWarningFormat("VWv" + majorVersion + " SETTING FILES");
            if (debugMode.value)
            {
        ...
        public void OnSettingsUI(UIHelperBase helperDefault)
        {
            ...
            {
                VWUtils.createElement<KlyteLocaleManager>(new GameObject(typeof(U).Name).transform);
                if (Locale.Get("K45_TEST_UP") != "OK")
                {
                    VWUtils.doErrorLog("CAN'T LOAD LOCALE!!!!!");
                }
